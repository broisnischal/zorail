...
// server. It runs the inbound SMTP ingest, the JSON API, the embedded web UI,
// an MCP server for agents, a forwarding worker, and a retention sweeper —
// all from one static binary, all over one config and one SQLite file.
package main
